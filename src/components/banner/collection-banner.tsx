  ...
  return (
    <section className={`relative w-full overflow-hidden ${className}`}>
      <div className="relative h-64 md:h-96">
        <FallbackImage
          src={collection.image?.url || "https://nailcissist.com/cdn/shop/files/Homepage_Banner.png?v=1732345686&width=1728"} // <-- leave empty string so you can set your own later
